...
- (void)viewDidLoad {
    ...
    if ([_toolbar respondsToSelector:@selector(setBarTintColor:)]) {
        _toolbar.barTintColor = [UIColor colorWithRed:99.0/255.0 green:92.0/255.0 blue:241.0/255.0 alpha:1.0];
    }
...
- (void)setNavBarAppearance:(BOOL)animated {
    ...
    if ([navBar respondsToSelector:@selector(setBarTintColor:)]) {
        navBar.barTintColor = [UIColor colorWithRed:99.0/255.0 green:92.0/255.0 blue:241.0/255.0 alpha:1.0];
...
- (void)storePreviousNavBarAppearance {
    ...
    if ([UINavigationBar instancesRespondToSelector:@selector(barTintColor)]) {
        _previousNavBarBarTintColor = [UIColor colorWithRed:99.0/255.0 green:92.0/255.0 blue:241.0/255.0 alpha:1.0];
    }
    _previousNavBarTranslucent = self.navigationController.navigationBar.translucent;
    _previousNavBarTintColor = [UIColor colorWithRed:99.0/255.0 green:92.0/255.0 blue:241.0/255.0 alpha:1.0];
